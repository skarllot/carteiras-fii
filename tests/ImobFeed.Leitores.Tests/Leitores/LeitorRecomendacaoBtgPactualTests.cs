...
BTRA11 2,5% BTG Pactual Agronegócio 90,7 103,8 0,87x 17,1% - 9,3% 9,3%";
        ...
        recomendacao.Carteira[1].Peso.Valor.Should().Be(0.050m);
        recomendacao.Carteira[2].Peso.Valor.Should().Be(0.175m);
        recomendacao.Carteira[3].Peso.Valor.Should().Be(0.025m);
        recomendacao.Carteira[4].Peso.Valor.Should().Be(0.125m);
        recomendacao.Carteira[5].Peso.Valor.Should().Be(0.050m);
        recomendacao.Carteira[6].Peso.Valor.Should().Be(0.075m);
        recomendacao.Carteira[7].Peso.Valor.Should().Be(0.075m);
        recomendacao.Carteira[8].Peso.Valor.Should().Be(0.025m);
        recomendacao.Carteira[9].Peso.Valor.Should().Be(0.040m);
        recomendacao.Carteira[10].Peso.Valor.Should().Be(0.080m);
        recomendacao.Carteira[11].Peso.Valor.Should().Be(0.050m);
        recomendacao.Carteira[12].Peso.Valor.Should().Be(0.080m);
        recomendacao.Carteira[13].Peso.Valor.Should().Be(0.025m);
    }
}