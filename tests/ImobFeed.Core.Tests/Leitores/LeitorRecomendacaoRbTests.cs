...
15% XPML11 XPML11 15%";
        ...
        recomendacao.Carteira[0].Peso.Valor.Should().Be(0.05f);
        ...
        recomendacao.Carteira[7].Peso.Valor.Should().Be(0.15f);
        recomendacao.Carteira[8].Peso.Valor.Should().Be(0.15f);
    }
}